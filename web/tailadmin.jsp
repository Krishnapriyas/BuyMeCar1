<%-- 
    Document   : tailadmin
    Created on : Sep 12, 2016, 2:42:42 PM
    Author     : Satish
--%>
            ...
            <!-- <div class="col-md-4">
                    <div data-scrollreveal='over 0.8s'>
                        <div class="align-center" style="margin-top: 100px;">
                            ...
                            <h4 class="text-bold" style="font-size: 30px;">Choose by your preferences</h4>
                            <p>
                                Choose car by your preferences
                            </p>
                            <p>
                                to choose by a car by its model and budget,click by budget
                            </p>
                            <p>
                                to choose a car by a specific brand and model,click by brand
                            </p>
                        </div>
                    </div>
                </div>-->
